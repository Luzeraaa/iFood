...
<body>
	...
	<div class="container text-center">
		<h1 class="mb-5 mt-3">Restaurantes com menor pedido mínimo</h1>
		...
		<section class="row d-flex justify-content-around"> <c:forEach
			...
			<div class="card ">
				...
				<ul class="list-group list-group-flush text-center col-md-11">
					...
					<li class="list-group-item text-danger"><span class="fs-5">Pedido
							mínimo</span><br>${c.valorPedido }</li>
					<li class="list-group-item "><span class="fs-5">Tempo
							de Entrega</span><br>${c.tempoEntrega }</li>
